...
<body>
	...
	<!-- boolean result = number % 2 == 0
		if(number % 2 == 0){
		System.out.println("nubmer는 짝수입니다");
		}
		System.out.println("result: "+result); 와 같음-->
	...
	<h4> 조건식 주의사항</h4>
	<!-- EL이 아닌 일반 값이 오면 무조건 false를 반환함. 하지만 일반 값으로 true가 사용되는 것은 예외 -->
